...
#include <contrib/libs/log4cpp/Configurator.hh>
#include <vector>
...
//--avikulin--
//--Add some dependancies for extended logging functionality:
//--add username, add machine name, add stacktrace, add logging position
#include <util/system/user.h>
#include <util/system/hostname.h>
#include <util/system/progname.h>
#include <util/system/backtrace.h>
#include <library/tracer/Version.h>
