...
#include <contrib/libs/log4cpp/LoggingEvent.hh>
#include <contrib/libs/log4cpp/Priority.hh>
#include <contrib/libs/log4cpp/CategoryStream.hh>
#include <contrib/libs/log4cpp/threading/Threading.hh>
#include <contrib/libs/log4cpp/convenience.h>
