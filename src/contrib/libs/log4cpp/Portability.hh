...
#        include <contrib/libs/log4cpp/config-win32-stlport-boost.h>
#    else
#        include <contrib/libs/log4cpp/config-win32.h>
#    endif
...
#    include <contrib/libs/log4cpp/config-openvms.h>
#else
#   if defined(__MINGW32__)
#       include <contrib/libs/log4cpp/config-MinGW32.h>
#
#   //---avikulin-- File is absent in official packet
#   else
#       include <contrib/libs/log4cpp/config.h>
#   endif
#endif
#endif

#include <contrib/libs/log4cpp/Export.hh>
