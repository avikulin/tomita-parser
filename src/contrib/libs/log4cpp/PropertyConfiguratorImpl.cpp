...
// appenders
#include <contrib/libs/log4cpp/Appender.hh>
#include <contrib/libs/log4cpp/OstreamAppender.hh>
#include <contrib/libs/log4cpp/FileAppender.hh>
#include <contrib/libs/log4cpp/RollingFileAppender.hh>
#include <contrib/libs/log4cpp/DailyRollingFileAppender.hh>
#include <contrib/libs/log4cpp/AbortAppender.hh>
#ifdef WIN32
#include <contrib/libs/log4cpp/Win32DebugAppender.hh>
#include <contrib/libs/log4cpp/NTEventLogAppender.hh>
#endif
#ifndef LOG4CPP_DISABLE_REMOTE_SYSLOG
#include <contrib/libs/log4cpp/RemoteSyslogAppender.hh>
#endif // LOG4CPP_DISABLE_REMOTE_SYSLOG
#ifdef LOG4CPP_HAVE_LIBIDSA
#include <contrib/libs/log4cpp/IdsaAppender.hh>
#endif	// LOG4CPP_HAVE_LIBIDSA
#ifdef LOG4CPP_HAVE_SYSLOG
#include <contrib/libs/log4cpp/SyslogAppender.hh>
#endif

// layouts
#include <contrib/libs/log4cpp/Layout.hh>
#include <contrib/libs/log4cpp/BasicLayout.hh>
#include <contrib/libs/log4cpp/SimpleLayout.hh>
